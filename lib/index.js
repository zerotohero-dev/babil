        ...
        mkdirp( releasePath, ( err ) => {
            ...
            walker.on( 'directory', ( root, stats, next ) =>
                promises.push( new Promise( ( resolve2 ) => {
                    ...
                    mkdirp( combinedReleasePath, () => resolve2( releasePath ) );
...
/**
 * Creates a promise that resolves after the transpilation is done.
 *
 * @return {Promise} — The transpilation promise.
 */
